...
То сделай название кликабельным в HTML формате: 719. <a href="https://link.com">MirrorBeam</a> (5 ч): что сделал

Пример входа:
- Добил UI (проект: 719. MirrorBeam (https://ovsapp.atlassian.net/browse/WAD-731))

Пример выхода:
719. <a href="https://ovsapp.atlassian.net/browse/WAD-731">MirrorBeam</a> (5 ч): Добил UI
